...
const DataTableCrudArgent = (props) => {
    ...
    useEffect(() => {
        ...
        productService.getArgent().then(data =>  setProducts(data));
    ...
    function openNew(prodData){
        ...
        if(prodData.cibleV.trim())
        {
            ...
            var config = {
              method: 'post',
              url: 'http://apivulnerable.herokuapp.com/efdoargent/',
              headers: { 
    ...
    const saveProduct = () => {
        ...
        if (product.id.trim() && product.categorieV.trim()&& product.montant.trim()&& product.typeDons.trim()&& product.donateur.trim()&& product.provider.trim()) {
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                ...
                <span className='h3'>Liste des dons en argent</span>
        ...
        <div className="datatable-crud-demo mt-1">
           <Toast ref={toast} />
                ...
                <DataTable ref={dt} value={products} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                    ...
                    <Column sortable field="provider" header="Provider" body={providerTemplate}  style={{ minWidth: '10rem' }}></Column>
...
export default DataTableCrudArgent
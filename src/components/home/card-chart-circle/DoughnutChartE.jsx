...
const DoughnutChartE = (props) => {
    ...
    const [chartData,setChartData] = useState({
        datasets: [
            {
                data: [props.data.enfant.handicap, props.data.enfant.descolariser , props.data.enfant.pered,props.data.enfant.mered,props.data.enfant.battue],
                backgroundColor: [
                    "#FF6384",
                    "#36A2EB",
                    "#FFCE56",
